...
import (
	...
	rag_app "github.com/aria3ppp/rag-server/internal/rag/app"
	rag_config "github.com/aria3ppp/rag-server/internal/rag/config"
...
func init() {
	var config rag_config.ServerConfig
